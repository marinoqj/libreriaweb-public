...
public class ForwardConstants {
	...
	public static final String FWD_LISTADO_PRODUCTOS = "ListadoProductos";
	public static final String FWD_LISTADO_PRODUCTOS_CARRO = "ListadoProductosCarro";
	public static final String FWD_DATOS_CLIENTE_FORM = "DatosClienteForm";
